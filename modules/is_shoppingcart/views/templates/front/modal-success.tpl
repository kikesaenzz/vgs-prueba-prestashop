{* Override del tema: los textos de este módulo no traen traducción al español
   y la tienda es toda en español, como el diseño. *}
{extends file='components/modal.tpl'}

{block name='modal_extra_attribues'}id="blockcart-modal"{/block}
{block name='modal_title'}{l s='Producto añadido al carrito' d='Modules.Isshoppingcart.Modalsuccess'}{/block}
...
{block name='modal_footer'}
  <a href="{$cart_url}" class="btn btn-primary btn-block">{l s='Finalizar compra' d='Shop.Theme.Actions'}</a>
