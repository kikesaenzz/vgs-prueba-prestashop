...
{block name='modal_title'}{l s='Filtros' d='Shop.Theme.Catalog'}{/block}
...
{block name='modal_footer'}
  <button type="button" class="btn btn-block btn-primary" data-dismiss="modal" aria-label="Cerrar">
    {l s='Ver resultados' d='Shop.Istheme'}
  </button>
{/block}
